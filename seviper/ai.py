...
ACCURACY_FEATURES = [i + 1 for i in range(100)]
...
class BinaryImageTeamPokemon:
    ...
    POKE_NAME_1D_INDEX_TO_2D = make_feature_1d_index_to_2d(INDEX_1D_TO_2D, POKE_NAME_FEATURES, False)
    TYPE_1D_INDEX_TO_2D = make_feature_1d_index_to_2d(INDEX_1D_TO_2D, parts.ALL_TYPES, False)
    LEARNSET_1D_INDEX_TO_2D = make_feature_1d_index_to_2d(INDEX_1D_TO_2D, parts.ALL_MOVE_NAMES, False),
    BASE_STATE_1D_INDEX_TO_2D = make_feature_1d_index_to_2d(INDEX_1D_TO_2D, BASE_STATE_FEATURES, True),
    ...
    ITEM_1D_INDEX_TO_2D = make_feature_1d_index_to_2d(INDEX_1D_TO_2D, ITEM_FEATURES, False)

    MOVE_NAME_1D_INDEX_TO_2D = make_feature_1d_index_to_2d(INDEX_1D_TO_2D, MOVE_NAME_FEATURES, False)
    MOVE_POWER_1D_INDEX_TO_2D = make_feature_1d_index_to_2d(INDEX_1D_TO_2D, MOVE_POWER_FEATURES, True)
    MOVE_ACCURACY_1D_INDEX_TO_2D = make_feature_1d_index_to_2d(INDEX_1D_TO_2D, ACCURACY_FEATURES, True)
...
class BinaryImageTeam:
    def __init__(self):
        self.images = [BinaryImageTeamPokemon() for _ in range(MAX_TEAM_NUM)]
